...
<script>
import BackIcon from '@/site/assets/common/back.svg';
import NextIcon from '@/site/assets/common/next.svg';
import SearchIconIcon from '@/site/assets/common/searchIcon.svg';
import HomeIcon from '@/site/assets/common/home.svg';
import MonitorIcon from '@/site/assets/common/monitor.svg';
import SearchIcon from '@/site/assets/common/search.svg';
import WarningIcon from '@/site/assets/common/warning.svg';
import icon5 from '@/site/assets/common/icon_5.svg';
import icon6 from '@/site/assets/common/icon_6.svg';
import icon7 from '@/site/assets/common/icon_7.svg';
