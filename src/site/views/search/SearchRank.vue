...
import AmountIcon from '@/site/assets/search/数量.svg';
import MIcon from '@/site/assets/search/金额.svg';
import { fetchRank } from '@/site/util/http';
import { FUND_TYPE } from '@/site/util/type';
import DuraChart from '@/site/components/charts/DualChart.vue';
