...
<script>
import LineContainer from '@/site/components/charts/LineContainer.vue';
import ProfileCard from '@/site/components/charts/ProfileCard.vue';
import { fetchOrgPortraitDetail } from '@/site/util/http';
import HosIcon from '@/site/assets/search/hospital.svg';
import RoundBarchart from '@/site/components/charts/RoundBarchart.vue';
