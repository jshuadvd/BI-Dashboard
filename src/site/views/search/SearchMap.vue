...
<script>
import Map from '@/site/components/charts/Map.vue';
import {
  fetchOrgPortraitBasic, fetchDetail, fetchOrgInfo,
} from '@/site/util/http';
import { LMarker, LPopup } from 'vue2-leaflet';
import L from 'leaflet';
import image1 from '@/site/assets/search/map/1.png';
import image2 from '@/site/assets/search/map/2.png';
import image3 from '@/site/assets/search/map/3.png';
import image4 from '@/site/assets/search/map/4.png';
import image5 from '@/site/assets/search/map/5.png';
import image6 from '@/site/assets/search/map/6.png';
import Vue2LeafletMarkercluster from 'vue2-leaflet-markercluster';
// import * as d3 from 'd3';
import Piechart from '@/site/components/small/Piechart.vue';
import Vue from 'vue';
