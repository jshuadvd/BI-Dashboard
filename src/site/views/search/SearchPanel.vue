...
<script>
import GirlIcon from '@/site/assets/search/icon_1.svg';
import BoyIcon from '@/site/assets/search/icon_2.svg';
import { fetchDoctorInfo, fetchPatientInfo, fetchInfo } from '@/site/util/http';
