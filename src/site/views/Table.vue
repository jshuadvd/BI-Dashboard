...
<script>
import getSpan from '@/site/util/tableHeader';
    ...
    async getModule() {
      ...
      switch (path) {
        case '/search/jigou/table':
          module = await import('@/site/util/table/rank');
          break;
        case '/search/mingxi/table':
          module = await import('@/site/util/table/detail');
          break;
        case '/warning/action/people/table':
          module = await import('@/site/util/table/people');
          break;
        default:
          module = await import('@/site/util/table/org');
          break;
      }
