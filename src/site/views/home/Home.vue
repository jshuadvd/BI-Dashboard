...
import LineChartContainer from '@/site/views/home/LineChartContainer.vue';
import Calendar from '@/site/components/Calendar.vue';
import Sunburst from '@/site/components/Sunburst.vue';
import fakeData from '@/site/mixins/data2';
import fakeData2 from '@/site/mixins/flare-11.5.json';
