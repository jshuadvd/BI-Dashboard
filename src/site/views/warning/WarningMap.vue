...
<script>
import Icon1 from '@/site/assets/warning/icon_1.svg';
import Icon2 from '@/site/assets/warning/icon_2.svg';
import Icon3 from '@/site/assets/warning/icon_3.svg';
import Map from '@/site/components/charts/Map.vue';
import OrgTable from '@/site/views/warning/comp/OrgTable.vue';
import { fetchFundMonitorInfo, fetchOrgViolationInfo } from '@/site/util/http';
import Vue2LeafletMarkercluster from 'vue2-leaflet-markercluster';
import { divIcon, Point } from 'leaflet';
import Barchart from '@/site/components/charts/Barchart.vue';
