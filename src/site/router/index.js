...
import Landing from '@/site/views/landing/Landing.vue';
import Layout from '@/site/views/Layout.vue';
  ...
  { path: '/warning', redirect: '/warning/budget/public' },
  {
    ...
    children: [
      ...
      },
      {
        ...
        name: '智能预警-参保人',
        component: () => import('@/site/views/warning/WarningPeople.vue'),
        meta: {
          linkIndex: 2,
          activeIndex: 1,
          table: true,
      ...
      },
      {
        ...
        name: '智能预警-药师',
        component: () => import('@/site/views/warning/WarningList.vue'),
        meta: {
          linkIndex: 2,
          activeIndex: 1,
        },
      },
      {
        ...
        name: '智能预警-机构',
        component: () => import('@/site/views/warning/WarningMap.vue'),
        meta: {
          linkIndex: 2,
          activeIndex: 1,
        },
